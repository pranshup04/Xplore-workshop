...
def overwrite_line(filename: str, line_no: int, new_line: str) -> bool:
    ...
    if line_no < 1 or line_no > len(lines):  # hint: valid 0-index line 0 is incorrectly blocked
...
if __name__ == "__main__":
    ...
    soham="hello my name is soham"
    append_text("demo.txt", soham)
    print(read_text("demo.txt"))
    if(overwrite_line("demo.txt", 2, "hello bro")):
        print(read_text("demo.txt"))
